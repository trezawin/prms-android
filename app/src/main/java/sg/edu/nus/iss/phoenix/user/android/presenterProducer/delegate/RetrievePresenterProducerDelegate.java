package sg.edu.nus.iss.phoenix.user.android.presenterProducer.delegate;
...
public class RetrievePresenterProducerDelegate extends AsyncTask<String, Void, String> {
    private static final String TAG = RetrievePresenterProducerDelegate.class.toString();
    ...
    protected void onPostExecute(String result) {
        ...
        reviewSelectPresenterProducerController.userRetrieved(userList);
    }
}
