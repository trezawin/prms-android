        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                ...
                if (rp2edit == null) { // Newly created.
                    ...
                    ControlFactory.getProgramController().createProgram(rp);
                }
                else { // Edited.
                    ...
                    ControlFactory.getProgramController().updateProgram(rp2edit);
                }
                return true;
            // Respond to a click on the "Delete" menu option
            case R.id.action_delete:
                Log.v(TAG, "Deleting radio program " + rp2edit.getRadioProgramName() + "...");
                ControlFactory.getProgramController().deleteProgram(rp2edit);
                return true;
            // Respond to a click on the "Cancel" menu option
            case R.id.action_cancel:
                Log.v(TAG, "Canceling creating/editing radio program...");
                ControlFactory.getProgramController().cancelCreateEditProgram();
                return true;
        }
